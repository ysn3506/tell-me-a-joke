...
// f5cf885b2d87421ab5ba642195160ade
...
console.log(joke)
        VoiceRSS.speech({
            key: 'f5cf885b2d87421ab5ba642195160ade',
            src: joke,
            hl: 'en-us',
            v: 'Linda', 
            r: 0, 
...
const getJokes=async()=>{
    let joke=''
    const apiUrl='https://sv443.net/jokeapi/v2/joke/Dark?blacklistFlags=nsfw,religious,political,racist,sexist&type=twopart'
    try {
